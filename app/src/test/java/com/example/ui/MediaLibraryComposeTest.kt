...
import com.example.ui.components.MediaItemActions
import com.example.ui.screens.IpodPodcastEpisodesScreen
...
class MediaLibraryComposeTest {
    ...
    @Test fun rankingHeaderHasNoExternalBrandOrLink() {
        compose.setContent {
            com.example.ui.components.RankingSourceHeader(
                com.example.data.repository.RankingInfo("Spotify / RadiosNet", "https://example.org", "Popularidade", "20 programas populares.", true),
                Color.Black)
        }
