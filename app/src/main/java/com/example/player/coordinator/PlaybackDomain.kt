...
fun com.example.data.model.RadioStation.toPlaybackQueueItem(): PlaybackQueueItem {
...
fun PlaybackQueueItem.toRadioStation(): com.example.data.model.RadioStation {
    return com.example.data.model.RadioStation(
        id = id,
        name = title,
        streamUrl = mediaUri,
        favicon = artworkUri ?: "",
