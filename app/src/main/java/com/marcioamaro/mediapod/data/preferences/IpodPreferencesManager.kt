package com.marcioamaro.mediapod.data.preferences
...
class IpodPreferencesManager private constructor(context: Context) {
    ...
    fun saveLastPlayedPodcast(episode: com.marcioamaro.mediapod.data.model.PodcastEpisode, show: com.marcioamaro.mediapod.data.model.PodcastShow?) {
        try {
    ...
    fun getLastPlayedPodcast(): Pair<com.marcioamaro.mediapod.data.model.PodcastEpisode, com.marcioamaro.mediapod.data.model.PodcastShow?>? {
        val epStr = prefs.getString(KEY_LAST_PODCAST_EPISODE_JSON, null) ?: return null
        return try {
            val obj = JSONObject(epStr)
            val ep = com.marcioamaro.mediapod.data.model.PodcastEpisode(
                id = obj.getString("id"),
            ...
            val show = showStr?.let {
                ...
                com.marcioamaro.mediapod.data.model.PodcastShow(
    ...
    fun getYouTubeVideos(): List<com.marcioamaro.mediapod.data.model.YouTubeVideo> {
        val jsonStr = prefs.getString("custom_youtube_videos_json", null) ?: return emptyList()
        return try {
            val array = org.json.JSONArray(jsonStr)
            val list = mutableListOf<com.marcioamaro.mediapod.data.model.YouTubeVideo>()
            for (i in 0 until array.length()) {
                val obj = array.getJSONObject(i)
                list.add(
                    com.marcioamaro.mediapod.data.model.YouTubeVideo(
                        id = obj.optString("id", ""),
    ...
    fun addYouTubeVideo(video: com.marcioamaro.mediapod.data.model.YouTubeVideo) {
        try {
